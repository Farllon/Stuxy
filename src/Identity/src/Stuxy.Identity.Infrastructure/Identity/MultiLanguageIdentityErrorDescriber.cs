...
using Stuxy.Identity.Infrastructure.Identity.ResourcesFiles;

namespace Stuxy.Identity.Infrastructure.Identity
{
    public class MultiLanguageIdentityErrorDescriber : IdentityErrorDescriber
    {
        private readonly IStringLocalizer<Resources> _localizer;

        public MultiLanguageIdentityErrorDescriber(IStringLocalizer<Resources> localizer)
        {
